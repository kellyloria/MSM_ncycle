...
w <- mean(2.8, 3.6, 3.6, 4.5, 2.9, 4.3, 1.9, 2.3, 2.1, 1.5, 1.7, 2.1, 2.0, 1.8, 2.4)
...
v
## Enter average width measurement in m
w <- c(2.8, 3.6, 3.6, 4.5, 2.9, 4.3, 1.9, 2.3, 2.1, 1.5, 1.7, 2.1, 2.0, 1.8, 2.4)
w <-mean(w)
## Calculate effective depth
z <- (Q/1000)/(w*v)
z
...
v
## Enter average width measurement in m
w <- c(2.8, 3.6, 3.6, 4.5, 3, 4.3, 2, 2.4, 2.1, 1.7, 1.8, 2.1, 2.3, 1.9, 2.5)
w <- mean(w)
## Calculate effective depth
z <- (Q/1000)/(w*v)
z
